...
(function ($) {
    $.hrmDefEmpType = function (options) {
        // Default options
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#HrmDefEmpType-form",
            formContainer: ".js-HrmDefEmpType-form-container",
            gridSelector: "#HrmDefEmpType-grid",
            gridContainer: ".js-HrmDefEmpType-grid-container",
            editSelector: ".js-HrmDefEmpType-edit",
            saveSelector: ".js-HrmDefEmpType-save",
            selectAllSelector: "#HrmDefEmpType-check-all",
            deleteSelector: ".js-HrmDefEmpType-delete-confirm",
            deleteModal: "#HrmDefEmpType-delete-modal",
            finalDeleteSelector: ".js-HrmDefEmpType-delete",
            clearSelector: ".js-HrmDefEmpType-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-HrmDefEmpType-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-HrmDefEmpType-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-EmpTypeCode-code").val();
                let name = self.val();
        ...
        function validation() {
            ...
            var attendanceType = $('#EmpTypeName').val();

            if (!attendanceType) {
                toastr.info('Enter Employee Type Name.');
                $('#EmpTypeName').trigger('focus')
                return false;
            }
