(function ($) {
   ...
   -------------------------------------------------------------- */
        ...
        function generateMonthWiseOrderPdf(reportData) {
            ...
            doc.save(`MonthWiseOrderReport_${Date.now()}.pdf`);
        }
        ...
        function generateStyleReportPdf(reportData) {
            ...
            doc.save(`MonthWiseOrderBookingStyleReport_${Date.now()}.pdf`);
        }
        ...
        function generateStylePoReportPdf(reportData) {
            ...
            addFooter(currentPage);
            doc.save(`MonthWiseOrderBookingStylePoReport_${Date.now()}.pdf`);
        }
        ...
        function generateStylePoCSReportPdf(reportData) {
            ...
            addFooter(currentPage);
            const fileName = `MonthWiseOrderBookingStylePOColorSizeReport_${Date.now()}.pdf`;
            doc.save(fileName);
        }
