(function ($) {
    $.monthlyOTReport = function (options) {
        const settings = $.extend({
            ...
            previewContainer: "#monthlyOtReport-container .card-body",
        ...
        const showPreview = () => {
            ...
            $("#monthlyOtReport-container").show();
            ...
            $.ajax({
                ...
                error: xhr => {
                    hideLoading();
                    $("#monthlyOtReport-container").hide();
        ...
        const bindUIEvents = () => {
            $("#previewBtn").on("click", () =>
                $("#monthlyOtReport-container").is(':visible') ? hidePreview() : showPreview()
            );
