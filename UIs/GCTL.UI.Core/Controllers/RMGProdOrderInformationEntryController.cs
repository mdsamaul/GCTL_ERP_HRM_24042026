...
namespace GCTL.UI.Core.Controllers
{
    public class RMGProdOrderInformationEntryController : BaseController
    {
        ...
        public async Task<IActionResult> GetOrderDetailsList(string integraJobNo = null)
        {
            try
            {
                ...
                var filter = new DataTableFilter
                {
                    ...
                    Length = length,
                    SearchValue = searchValue,
                    IntegraJobNo = integraJobNo // 🔥 job filter পাঠানো হচ্ছে
                };
        ...
        //[HttpPost]
        //public async Task<IActionResult> SaveColorSizeBreakup([FromBody] RMG_Prod_Temp_ColorSizeBreakupDto breakupDto)
        //{
        //    try
        //    {
        //        if (breakupDto == null)
        ...
        //        var result = await rMGProdOrderInformationEntryService.SaveColorSizeBreakupAsync(breakupDto, LoginInfo);
        ...
        //    try
        //    {
        //        await rMGProdOrderInformationEntryService.PoIjobNoGetTempAsync(OrderJobDto);
        //        return Ok();
        //    }
        //    catch (Exception)
        //    {
